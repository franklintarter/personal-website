...
And we're done! See the [source code](https://github.com/franklintarter/modern-cms-gatsby-contentful) for the finished result and tinker around with more advanced content models.
